...
cell_size = 20
# Center the 60x60 grid (3 cells × 20 units) within the 125x125 area
# Offset: (125 - 60) / 2 = 32.5 for both x and y
grid_origin = (32.5, 32.5)
...
def draw_grid():
    ...
    for i in range(1, 3):
        ...
        pen_up()
    # Move to corner after drawing grid
    go(grid_origin[0] - 10, grid_origin[1] - 10)
